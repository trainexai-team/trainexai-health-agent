  ...
  const runDemo = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        // Report might not have enough data yet
      }
      await new Promise((r) => setTimeout(r, 1000));
      setCurrentStep(7);
    } catch (err: any) {
                  ...
                  <div className="py-4">
                    {report ? (
                      <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-3">
                          <div className="p-4 rounded-xl bg-brand-50 border border-brand-100 text-center">
                            <p className="text-2xl font-bold text-brand-600">{Math.round(report.avg_consistency_score)}</p>
                          ...
                          <div className="p-4 rounded-xl bg-accent-50 border border-accent-100 text-center">
                            <p className="text-2xl font-bold text-accent-600">{Math.round(report.workout_adherence)}%</p>
                      ...
                      <div className="p-4 rounded-xl bg-gray-50 border border-gray-100 text-center">
                        <p className="text-gray-500">Weekly report data will appear once you have 7 days of check-ins.</p>
                      </div>
                    )}
                  </div>
                )}
